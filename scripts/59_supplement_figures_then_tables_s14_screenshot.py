...
SOURCE_SUPP = (
    ...
    "three_stage_bridge_transport_supplementary_materials_interleaved_FigureS1-S14_TableS1-S25.docx"
)
SOURCE_MAIN = (
    ROOT
    / "JOSR_supplement_interleaved_S1_S14_T1_T25_20260722/manuscript/"
...
SUPP_OUT = (
    MANUSCRIPT_DIR
    / "three_stage_bridge_transport_supplementary_materials_FiguresS1-S14_then_TablesS1-S25_S14_screenshot.docx"
)
MAIN_OUT = (
    MANUSCRIPT_DIR
    / "three_stage_bridge_transport_manuscript_JOSR_clinical_translation_preserve_images_unchanged.docx"
...
def main() -> None:
    ...
    out_doc.add_paragraph(
        "Supplementary materials are arranged with all figures first, followed by all tables. Numbering is unified as Figure S1-Figure S14 and Table S1-Table S25."
    )
    ...
    MANIFEST.write_text(
        "\n".join(
            [
                ...
                "- Placed Figure S1-Figure S14 together before Table S1-Table S25.",
