...
REPO = (
    ROOT
    / "stage_specific_progression_framework/complete_project_analysis/github_release/"
...
def main() -> None:
    ...
    manifest.write_text(
        "\n".join(
            [
                ...
                f"- Supplementary tables extracted from `{SUPP_DOCX}`: {supp_tables}",
                "",
    ...
    print(f"main_tables={main_tables} supplementary_tables={supp_tables}")
