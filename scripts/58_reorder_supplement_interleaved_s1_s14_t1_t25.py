...
def build_supplement() -> None:
    ...
    doc.add_paragraph(
        "Supplementary figures and tables are arranged by the manuscript story line. Numbering is unified as Figure S1-Figure S14 and Table S1-Table S25; earlier extra-material labels have been removed."
    )
    ...
    MANIFEST.write_text(
        "\n".join(
            [
                ...
                "- Used only Figure S1-Figure S14 and Table S1-Table S25 numbering.",
